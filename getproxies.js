                            ...
                            columns: [
                              ...
                              },
                              {
                                ...
                                formatter: (_, row) =>
                                  ...
                                  <select id="ipv6Dns-${row.cells[0].data}" class="ipv6Dns" onchange="changeDns(this.id)"> <option value="none" selected="" disabled="" hidden=""> Disabled </option> <option value="Disabled">${row.cells[4].data}</option> </select>
